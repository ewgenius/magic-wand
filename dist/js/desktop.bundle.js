	...
	var Application = function () {
	  ...
	  _createClass(Application, [{
	    ...
	    value: function start() {
	      ...
	      var stream = this.pubsub.subscribe(channel);
	      stream.onValue(function (value) {
	        return _this2.onUpdate(value);
	      });
	...
	var Pubsub = function () {
	  ...
	  _createClass(Pubsub, [{
	    ...
	    value: function subscribe(channel) {
	      ...
	      var stream = _baconjs2.default.fromBinder(function (sink) {
	        _this.pubnub.subscribe({
	          channel: channel,
	          message: sink
	        });
	        return function () {
	          return _this.pubnub.unsubscribe({
	            channel: channel
	          });
	        };
	      });
